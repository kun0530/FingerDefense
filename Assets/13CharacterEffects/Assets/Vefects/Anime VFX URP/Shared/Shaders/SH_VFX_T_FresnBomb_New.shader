	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 temp_output_30_0 = ( saturate( lerpResult23 ) + ( IN.ase_texcoord4.z + _DissolveEro ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float4 tex2DNode16 = tex2D( _DissolveTexture, panner19 );
				float4 lerpResult23 = lerp( tex2DNode16 , ( 1.0 - tex2DNode16 ) , _DissolveInvert);
				float4 temp_output_30_0 = ( saturate( lerpResult23 ) + ( IN.ase_texcoord1.z + _DissolveEro ) );
				float4 temp_cast_0 = (_CorePower).xxxx;
				float4 temp_output_52_0 = saturate( ( ( pow( temp_output_30_0 , temp_cast_0 ) * _CoreIntensity ) + ( temp_output_30_0 * _GlowIntensity ) ) );
				float3 ase_worldPos = IN.ase_texcoord2.xyz;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV62 = dot( IN.normalWS, ase_worldViewDir );
				float fresnelNode62 = ( _FrBias1 + _FrScale1 * pow( 1.0 - fresnelNdotV62, _FrPower1 ) );
				float temp_output_78_0 = saturate( fresnelNode62 );
				float4 temp_cast_1 = (temp_output_78_0).xxxx;
				float fresnelNdotV39 = dot( IN.normalWS, ase_worldViewDir );
				float fresnelNode39 = ( _FrColorBias + _FrColorScale * pow( 1.0 - fresnelNdotV39, _FrColorPower ) );
				float temp_output_43_0 = saturate( fresnelNode39 );
				float4 temp_cast_2 = (temp_output_43_0).xxxx;
...
Node;AmplifyShaderEditor.SamplerNode;16;-5376,0;Inherit;True;Property;_DissolveTexture;Dissolve Texture;0;0;Create;True;0;0;0;False;3;Space(33);Header(Dissolve);Space(13);False;-1;8e9f6e86d964cef4db775abb71619b05;8e9f6e86d964cef4db775abb71619b05;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;35;-2944,896;Inherit;False;Property;_ColorIn;Color In;5;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;37;-2944,1152;Inherit;False;Property;_ColorExt;Color Ext;6;0;Create;True;0;0;0;False;0;False;0,0.6901961,1,0;0,0.6897702,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=ECB43BEC5DDEEC960D0BC513D0ED75433035D750